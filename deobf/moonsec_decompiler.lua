--[[
  ...
  Full credit to https://scriptblox.com/u/axos

  This Moonsec Decompiler were posted months ago (almost a year ago, but got removed as the respiratory on GitHub included other files that we're not supposed to be public and misuploaded because of a leaked token.)
  A lot of people have took my Decompiler and liked it, join my discord and you will see the vouchers and reactions.
  
  How to set this in visual Studio code :
  Put this script (the one I posted as a script) and name it "moonsec_decompiler.lua", then put the obfuscated script as a file and name it " ByteCode.luac"
  
  Install Lua5.1 before running.
  
  You can use it in a bot, credits are optional.
  
  Note : a person have stole my file without credits and gave credits to himself, he stole it long time ago and I don't know where did he post it but someone informed me.
  If you're reading this, give credits and stop stealing my fuckin stuff and claiming credits.
]]
