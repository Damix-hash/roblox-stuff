...
return {
    ...
    ["Light Clouds"] = {
        -- light clouds, looks really cool — better than plain gray
        StarCount = 3000,
    ...
    ["Black Space"] = {
        -- black skybox with stars, simple yet looks good
        StarCount = 0, SunAngularSize = 21, MoonAngularSize = 11,
    ...
    ["Earth Orbit"] = {
        -- earth feel, more of a space vibe
        StarCount = 3000, SunAngularSize = 0, MoonAngularSize = 0,
    ...
    ["Deep Space"] = {
        -- prettiest type of space, lots of stars, more detail
    ...
    ["Vertical Milky Way"] = {
        StarCount = 3000, SunAngularSize = 1.44, MoonAngularSize = 0.57,
